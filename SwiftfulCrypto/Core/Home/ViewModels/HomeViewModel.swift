    ...
    func addSubscribers() {
        ...
        $allCoins
            ...
            .sink { [weak self] returnedCoins in
                ...
                self.portfolioCoins = self
                    .sortPortfolioCoinsIfNeeded(coins: returnedCoins)
            }
            .store(in: &cancellables)
        
        // adding prints of returning all coins and portfolio coins for example to debug and avoid calling 2-3 times.
    ...
    private func sortPortfolioCoinsIfNeeded(coins: [CoinModel]) -> [CoinModel] {
        switch sortOption {
            ...
            case .holdings:
                return coins
                    .sorted(
                        by: {$0.currentHoldingsValue > $1.currentHoldingsValue
                        })
